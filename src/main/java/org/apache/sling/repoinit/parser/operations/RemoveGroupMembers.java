...
public class RemoveGroupMembers extends Operation {
     ...
     * @param groupname the name of the group from which members are to be removed
     */
    ...
    public String asRepoInitString() {
        return String.format(
                "remove %s from group %s%n",
                listToString(QuotableStringUtil.forRepoInitString(members)),
